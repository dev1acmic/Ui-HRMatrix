...
export const getJobApplicationsById = (jobapplicationId) => async (
  dispatch
) => {
  try {
...
export const getApplicantAssessment = (level, applicantId) => async (
  dispatch
) => {
  try {
...
export const checkAssessmentAccess = (level, applicantId) => async (
  dispatch
) => {
  try {
    const res = await client.service("applicantassessments").find({
...
export const getApplicantAssessmentLevelsAndScore = (applicantId) => async (
  dispatch
) => {
  try {
    const res = await client.service("applicantassessments").find({
...
export const deleteApplicantInterviewers = (applicantinterviewerId) => async (
  dispatch
) => {
  let res;
  try {
