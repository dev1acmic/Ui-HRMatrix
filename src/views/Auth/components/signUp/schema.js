export default {
  ...
  phoneNumber: {
    ...
    format: {
      ...
      message: "TRANSLATION.phninvalid",
    },
    length: {
      maximum: 12,
      minimum: 10,
  ...
  companyName: {
    presence: { allowEmpty: false, message: "TRANSLATION.companynametooshort" },
    length: {
      maximum: 75,
      minimum: 5,
      message: "TRANSLATION.companynametooshort",
    },
  },
  // designation: {
  //   presence: {  allowEmpty: true, message: "TRANSLATION.designationrequired" },
  //   length: {
  //     maximum: 50,
  //     minimum: 3,
  //     message: "TRANSLATION.designationtooshort",
  //   },
  // },
  password: {
    ...
    length: {
      minimum: 8,
      maximum: 128,
      message: "TRANSLATION.passwordtooshort",
    },
    format: {
